...
public class SelectR2dbcKeyGenerator implements R2dbcKeyGenerator {
    ...
    private final ReactiveExecutor reactiveMybatisExecutor;
     ...
     */
    public SelectR2dbcKeyGenerator(SelectKeyGenerator selectKeyGenerator, ReactiveConfiguration r2dbcMybatisConfiguration, ReactiveExecutor reactiveMybatisExecutor) {
    ...
    public Mono<Boolean> processSelectKey(KeyGeneratorType keyGeneratorType, MappedStatement ms, Object parameter) {
        ...
        try {
            if (parameter != null && keyStatement != null && keyStatement.getKeyProperties() != null) {
                ...
                return this.reactiveMybatisExecutor.query(keyStatement, parameter)
                        .collectList()
                        .flatMap(values -> {
                            if (values.isEmpty()) {
