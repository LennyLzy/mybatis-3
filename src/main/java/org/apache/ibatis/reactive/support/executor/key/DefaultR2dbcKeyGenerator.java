 ...
 */
package org.apache.ibatis.reactive.support.executor.key;
...
public class DefaultR2dbcKeyGenerator implements R2dbcKeyGenerator {
    ...
    private final ReactiveConfiguration r2dbcMybatisConfiguration;
     ...
     */
    public DefaultR2dbcKeyGenerator(MappedStatement mappedStatement, ReactiveConfiguration r2dbcMybatisConfiguration) {
    ...
    private void assignKeys(ReactiveConfiguration configuration,
    ...
    private void assignKeysToParam(ReactiveConfiguration configuration, RowResultWrapper rowResultWrapper,
    ...
    private void assignKeysToParamMapList(ReactiveConfiguration configuration, RowResultWrapper rowResultWrapper,
    ...
    private void assignKeysToParamMap(ReactiveConfiguration configuration,
                                      RowResultWrapper rowResultWrapper,
                                      String[] keyProperties,
                                      Map<String, ?> paramMap) {
        if (paramMap.isEmpty()) {
    ...
    private Map.Entry<String, KeyAssigner> getAssignerForParamMap(ReactiveConfiguration config,
                                                                  int columnPosition,
                                                                  Map<String, ?> paramMap,
                                                                  String keyProperty,
                                                                  String[] keyProperties,
    ...
    private Map.Entry<String, KeyAssigner> getAssignerForSingleParam(ReactiveConfiguration r2DbcMybatisConfiguration,
    ...
    private class KeyAssigner {
         ...
         */
        protected KeyAssigner(ReactiveConfiguration r2DbcMybatisConfiguration,
                              int columnPosition,
                              String paramName,
                              String propertyName) {
            super();
