...
public class R2dbcResultSetsHandler {
  ...
  private <T> Mono<T> handleRowValues(Result result, ResultMap resultMap, ResultHandler<?> resultHandler, ResultMapping parentMapping) {
  ...
  private <T> Mono<T> handleRowValuesForSimpleResultMap(Result result, ResultMap resultMap, ResultHandler<?> resultHandler, ResultMapping parentMapping) {
